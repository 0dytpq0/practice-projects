...
// item-stretch를 쓸때에는 해당 자식들의 높이가 명시되어 있으면 안된다.
...
export default function AlignTest() {
  ...
  //prettier-ignore
  const justifies = ['justify0start', 'justify-center','justify-end','justify-between','justify-around','justify-evenly'].map(justify => (
